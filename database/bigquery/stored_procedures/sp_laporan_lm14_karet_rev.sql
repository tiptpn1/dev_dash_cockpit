CREATE OR REPLACE PROCEDURE `dashboard-cockpit.data_dash.sp_laporan_lm14_karet_rev`(p_region STRING, p_plant STRING, p_tahun STRING, p_bulan STRING)
BEGIN
...
SELECT 'A. LUAS AREAL' as lev2, 'A.1. LUAS AREAL' as lev1, 
'0000' as kode,
