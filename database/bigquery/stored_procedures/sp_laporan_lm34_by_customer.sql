CREATE OR REPLACE PROCEDURE `dashboard-cockpit.data_dash.sp_laporan_lm34_by_customer`(p_komoditi STRING, p_region STRING, p_plant STRING, p_tahun STRING, p_bulan STRING)
BEGIN
...
FROM (
  ...
  GROUP BY plant, region, komoditi, customer_id, customer_name
) X
