...
class SidebarNavigationSeeder extends Seeder
{
    ...
    {
        // Deskripsi rujukan untuk kamus fitur
        $descriptions = [
            'operasional'     => 'Menu induk untuk seluruh modul operasional perkebunan',
            'pica'            => 'Menu induk untuk Problem Identification & Corrective Action',
            'warehouse'       => 'Menu induk untuk modul pergudangan dan logistik',
            'sales'           => 'Menu induk untuk modul sales, penyerahan, dan inventori',
            'aset'            => 'Menu induk untuk pengelolaan aset dan optimalisasi',
            'finansial'       => 'Menu induk untuk pelaporan dan konsolidasi keuangan',
            'hr'              => 'Menu induk untuk data kepegawaian dan L&D',
            'legal'           => 'Menu induk untuk administrasi hukum dan agraria',
            'progress'        => 'Menu induk untuk pemantauan target & SLA',
            'pengadaan'       => 'Menu induk untuk pelacakan proses pengadaan barang/jasa',
            'carbon'          => 'Menu induk untuk pemantauan sustainability & emisi karbon',
            'gis'             => 'Menu induk untuk sistem informasi geografis lahan',
            'skyview'         => 'Menu induk untuk sistem monitoring citra udara AGRO Skyview',
            'lm'              => 'Menu induk untuk laporan manajemen berkala (LM)',
            'pemasaran_karet' => 'Menu induk untuk monitoring sales & operation karet',
            'management'      => 'Menu induk untuk konfigurasi sistem management dan kontrol akses',

            'mrc' => 'Dashboard Management Reporting Cockpit',
            'operasional_amanah' => 'Dashboard AMANAH terintegrasi',
            'operasional_dfarm' => 'Dashboard DFarm Presensi & Produksi Karet',
            'operasional_cctv' => 'Monitoring CCTV PTPN I (dilengkapi legacy fallback ke slug cctv)',
            'operasional_onfarmkaret' => 'Dashboard visualisasi data on-farm karet',
            'operasional_onfarmteh' => 'Dashboard visualisasi data on-farm teh',
            'operasional_onfarmkopi' => 'Dashboard visualisasi data on-farm kopi',
            'operasional_offfarmkaret' => 'Dashboard visualisasi data pengolahan pabrik karet',
            'operasional_offfarmteh' => 'Dashboard visualisasi data pengolahan pabrik teh',
            'operasional_offfarmkopi' => 'Dashboard visualisasi data pengolahan pabrik kopi',
            'operasional_sdmpenyadap' => 'Dashboard monitoring SDM penyadap karet',
            'pica_kuadran' => 'Kuadran Problem Identifications (PICA)',
            'pica_corrective' => 'List Corrective Actions (PICA)',
            'sales_overview' => 'Sales overview reporting dashboard',
            'sales_comodities' => 'Sales commodity transactions dashboard',
            'sales_tea_inventory' => 'Sales tea stock and inventory tracking',
            'sales_rubber_delivery' => 'Rubber deliveries operations tracking',
            'sales_crm' => 'Customer Relationship Management dashboard',
            'sales_sonia' => 'Legacy sales tracking system (SSO)',
            'aset_peta' => 'Pemetaan aset fisik PTPN I',
            'aset_recovery' => 'Aset recovery monitoring & tracking',
            'aset_optimalisasi' => 'Aset optimalisasi analysis dashboard',
            'aset_divestasi' => 'Aset divestasi transactions tracking',
            'finansial_console' => 'Laporan keuangan konsolidasi',
            'finansial_parent' => 'Laporan keuangan perusahaan induk saja',
            'finansial_ratio' => 'Rasio keuangan & analisis performa',
            'finansial_executive' => 'Executive financial reporting dashboard',
            'finansial_sub' => 'Laporan keuangan anak perusahaan',
            'hr_demographics' => 'Demografi karyawan PTPN I',
            'hr_dev' => 'Learning & development employees tracking',
            'hr_revenue' => 'Analisis revenue & cost per employee',
            'hr_demographic' => 'Dashboard demografi detail',
            'hr_sgna' => 'Analisis biaya SG&A kepegawaian',
            'legal_tax' => 'Pemantauan relaksasi perpajakan',
            'legal_agraria' => 'Manajemen berkas legal & agraria',
            'progress_sla' => 'Capaian Service Level Agreement (SLA)',
            'pengadaan_pra' => 'Monitoring pra-proses pengadaan barang/jasa',
            'pengadaan_proses' => 'Monitoring proses berjalan pengadaan barang/jasa',
            'pengadaan_kontrak' => 'Monitoring realisasi kontrak pengadaan',
            'pengadaan_stok' => 'Analisis stok barang pergudangan',
            'carbon_emisi' => 'Monitoring emisi karbon & sustainability',
            'gis_areal' => 'GIS mapping areal tanaman dan lahan',
            'gis_ndvi' => 'GIS analysis NDVI & vegetative health index',
            'gis_cuaca' => 'GIS cuaca regional & ramalan cuaca terintegrasi',
            'skyview_table' => 'AGRO Skyview table reporting data',
            'skyview_exec' => 'Ringkasan eksekutif AGRO Skyview',
            'lm_13' => 'Laporan manajemen LM13',
            'lm_14' => 'Laporan manajemen LM14',
            'lm_16' => 'Laporan manajemen LM16',
            'lm_34' => 'Laporan manajemen LM34',
            'lm_62' => 'Laporan manajemen LM62',
            'pemasaran_karet_sales' => 'Realisasi penjualan operasional karet',
            'aigr1' => 'Menu aplikasi AIGR1',
            'garda' => 'Portal AI Garda Holding Perkebunan',
            'portalaplikasi' => 'Menu Portal Aplikasi',
            'evaluasi_aplikasi' => 'Sistem evaluasi aplikasi PTPN I',
            'management_users' => 'Manajemen data user dan pembuatan akun baru',
            'management_features' => 'Manajemen pendaftaran slug fitur baru dan Kamus Fitur',
            'management_features_dictionary' => 'Halaman Rujukan Kamus Fitur & Akses Kontrol',
            'management_access' => 'Manajemen otorisasi hak akses user ke fitur dan pantauan log login terakhir',
            'management_lastlogin' => 'Log riwayat aktivitas login terakhir pengguna',
        ];
        ...
        $children = [
            ...
            'aigr1'                    => ['name' => 'AIGR1', 'parent' => null, 'url' => '/portalaplikasi', 'icon' => 'fa-solid fa-robot', 'order' => 160],
            'garda'                    => ['name' => 'Garda AI', 'parent' => null, 'url' => 'https://gardaprep.holding-perkebunan.com/', 'icon' => 'fa-solid fa-fire-flame-curved', 'order' => 170],
            'portalaplikasi'           => ['name' => 'Portal Aplikasi', 'parent' => null, 'url' => '/portalaplikasi', 'icon' => 'fa-solid fa-th-large', 'order' => 180],
            'evaluasi_aplikasi'        => ['name' => 'Evaluasi Aplikasi', 'parent' => null, 'url' => 'https://evaluasi-aplikasi.ptpn1.co.id/', 'icon' => 'fa-solid fa-clipboard-check', 'order' => 190],
        ];
