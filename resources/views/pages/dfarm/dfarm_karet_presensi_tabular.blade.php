      ...
      <div class="bg-gradient-to-br from-slate-700 to-slate-800 rounded-lg p-4 border border-slate-600 shadow-lg backdrop-blur-sm mb-6">
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-xs md:text-sm">
            <thead>
              <tr class="bg-slate-600 text-white sticky top-0">
            ...
            <tbody>
              ...
              <tr class="border-b border-slate-600 hover:bg-slate-600 transition-colors">
                ...
                <td class="px-3 py-2 text-white font-medium">{{ $data->regional }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->kehadiran, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->sakit, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->cuti, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->libur, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->mangkir, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->dll, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->belum_hadir, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right font-semibold text-blue-300">{{ $data->prosentase }}%</td>
                <td class="px-3 py-2 text-white text-right font-semibold text-green-300">{{ $data->prosentase_kehadiran }}%</td>
                <td class="px-3 py-2 text-white text-right font-semibold">{{ number_format($data->total_pegawai, 0, ',', '.') }}</td>
              </tr>
              @empty
              <tr>
              ...
              <tr class="border-b border-slate-600 hover:bg-slate-600 transition-colors">
                ...
                <td class="px-3 py-2 text-white font-medium">Total</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($totalData['kehadiran'], 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($totalData['sakit'], 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($totalData['cuti'], 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($totalData['libur'], 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($totalData['mangkir'], 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($totalData['dll'], 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($totalData['belum_hadir'], 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right font-semibold text-blue-300">{{ $totalData['prosentase'] }}%</td>
                <td class="px-3 py-2 text-white text-right font-semibold text-green-300">{{ $totalData['prosentase_kehadiran'] }}%</td>
                <td class="px-3 py-2 text-white text-right font-semibold">{{ number_format($totalData['total_pegawai'], 0, ',', '.') }}</td>
              </tr>
            </tbody>
          </table>
        </div>
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-xs md:text-sm">
            ...
            <tbody>
              ...
              <tr class="border-b border-slate-600 hover:bg-slate-600 transition-colors">
                <td class="px-3 py-2 text-white">{{ $loop->iteration }}</td>
                <td class="px-3 py-2 text-white font-medium">{{ $data->kebun }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->kehadiran, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->sakit, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->cuti, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->libur, 0, ',', '.') }}</td>
        ...
        <div class="overflow-x-auto">
          <table class="w-full text-xs md:text-sm">
            ...
            <tbody>
              ...
              <tr class="border-b border-slate-600 hover:bg-slate-600 transition-colors">
                <td class="px-3 py-2 text-white">{{ $loop->iteration }}</td>
                <td class="px-3 py-2 text-white font-medium">{{ $data->afdeling }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->kehadiran, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->sakit, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->cuti, 0, ',', '.') }}</td>
                <td class="px-3 py-2 text-white text-right">{{ number_format($data->libur, 0, ',', '.') }}</td>
