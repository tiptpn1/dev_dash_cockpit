                    ...
                    <div class="form-group">
                        ...
                        @else
                            <select id="app_select" class="form-select">
                                ...
                                <option value="AGHRIS">AGHRIS</option>
                            </select>
                        @endif
                    </div>
                </div>
            ...
            <div class="table-card">
                ...
                <div id="hris-tabs-wrap" style="display: none;">
                    ...
                    <div id="tab-rekap" class="hris-tab-panel active">
                        <div class="filter-card-tab2"
                            ...
                            <div style="display:flex; align-items:center; gap:8px;">
                                <label class="form-label" style="margin:0; white-space:nowrap;"><i
                            ...
                            <table id="hris-table" class="report-table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="text-align: left;">Divisi <span
                                                style="font-weight:400;text-transform:none;">(klik untuk detail
                                                karyawan)</span></th>
                                        <th style="width: 200px;">Jumlah Hari Kerja<br><span
                                                style="font-size:11px;font-weight:400;text-transform:none;color:#e2e8f0;opacity:0.9;">s/d
                                                {{ \Carbon\Carbon::now()->translatedFormat('d F Y') }}</span></th>
                            ...
                            <table id="harian-table" class="report-table">
                                ...
                                <tbody id="harian-tbody">
                                    <tr class="loading-row">
                                        <td colspan="12">Pilih tanggal untuk menampilkan data.</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                            ...
                            <div class="filter-grid-tab2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div style="position: relative;">
                                        <input type="text" id="perkaryawan_nama_search" class="form-input"
                                            placeholder="Ketik minimal 3 huruf..." autocomplete="off">
                                        <div id="perkaryawan_nama_dropdown" class="dropdown-list"
                                            style="display: none; position: absolute; top: 100%; left: 0; right: 0; background: white; border: 1px solid #ddd; max-height: 300px; overflow-y: auto; z-index: 1000; border-radius: 4px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                                        </div>
                                    </div>
                                    <input type="hidden" id="perkaryawan_pegawai_id" value="">
                                    <div id="perkaryawan_selected_nama"
                                        style="margin-top: 8px; font-size: 12px; color: #6b7280;"></div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="table-wrapper">
                            <table id="perkaryawan-table" class="report-table">
                                ...
                                <tbody id="perkaryawan-tbody">
                                    <tr class="loading-row">
                                        <td colspan="10">Pilih regional, karyawan, dan range tanggal untuk menampilkan data.
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div id="tab-rekap_regional" class="hris-tab-panel">
                        ...
                        <div id="rekap-regional-chart-container"
                            style="padding: 20px; background: #fff; border-radius: 8px; border: 1px solid #e5e7eb; margin-top: 16px;">
                            <div style="text-align:center; padding:20px; color:#6b7280;"><i
                                    class="fas fa-spinner fa-spin"></i> Memuat data...</div>
                        </div>
                        <div id="rekap-regional-detail-container"
                            style="display: none; padding: 20px; background: #f8fafc; border-radius: 8px; border: 1px solid #e2e8f0; margin-top: 16px;">
                            <div style="font-weight: bold; font-size: 14px; color: #1e293b; margin-bottom: 16px; border-bottom: 1px solid #e2e8f0; padding-bottom: 8px;"
                                id="rekap-regional-detail-title">Detail Regional</div>
                            <div id="rekap-regional-detail-content"></div>
                        </div>

                        <div id="pegawai-log-modal"
                            style="display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 9999; align-items: center; justify-content: center;">
                            <div
                                style="background: #fff; border-radius: 8px; width: 90%; max-width: 800px; max-height: 90vh; display: flex; flex-direction: column; box-shadow: 0 4px 20px rgba(0,0,0,0.2);">
                                <div
                                    style="padding: 16px 20px; border-bottom: 1px solid #e2e8f0; display: flex; justify-content: space-between; align-items: center; background: #f8fafc; border-radius: 8px 8px 0 0;">
                                    <h3 style="margin: 0; font-size: 16px; font-weight: 700; color: #1e293b;"><i
                                            class="fas fa-calendar-check"
                                            style="color: #2563eb; margin-right: 8px;"></i>Riwayat Absensi: <span
                                            id="pegawai-log-name" style="color: #2563eb;"></span></h3>
                                    <button onclick="document.getElementById('pegawai-log-modal').style.display='none'"
                ...
                <div class="table-wrapper" id="non-hris-wrapper">
                    ...
                    <div id="placeholder-state" class="empty-state" style="display: none;">
                        ...
                        <h4 style="font-size: 14px; font-weight: 700; color: #374151;" id="placeholder-title">Data Belum
                            Tersedia</h4>
                        <p style="font-size: 12px; color: #6b7280; margin-top: 4px;" id="placeholder-desc">Data evaluasi
                            untuk aplikasi ini sedang dalam proses pengumpulan.</p>
                    </div>
                </div>
            </div>
    ...
    <div id="absensi-popup-overlay" class="absensi-popup-overlay" role="dialog" aria-modal="true">
        <div class="absensi-popup">
            <div class="absensi-popup-header">
                ...
                <button type="button" class="absensi-popup-close" id="absensi-popup-close"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateDashboard() {
                ...
                if (selectedApp === 'AGHRIS') {
                    window.location.href = '/evaluasi-aghris';
                    return;
                }
